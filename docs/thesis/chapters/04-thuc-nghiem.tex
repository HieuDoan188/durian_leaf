...
\midrule
Accuracy            & \textbf{98,19\%} & \textbf{97,30\%} \\
Precision (weighted) & ---             & 97,34\% \\
Recall (weighted)    & ---             & 97,30\% \\
$F_1$ (weighted)     & ---             & 97,31\% \\
\bottomrule
\end{tabular}
\end{table}

Mô hình phân loại đúng 866 trên 890 ảnh kiểm thử, tức chỉ sai 24 ảnh.

Khoảng cách giữa kiểm định (98,19\%) và kiểm thử (97,30\%) là 0,89 điểm phần trăm.
...
\midrule
Algal Leaf Spot     & \textbf{143} & 0 & 2 & 0 & 2 & 147 \\
Allocaridara Attack & 2 & \textbf{180} & 0 & 0 & 1 & 183 \\
Healthy Leaf        & 1 & 0 & \textbf{191} & 0 & 4 & 196 \\
Leaf Blight         & 2 & 1 & 3 & \textbf{181} & 1 & 188 \\
Phomopsis Leaf Spot & 3 & 1 & 1 & 0 & \textbf{171} & 176 \\
\bottomrule
\end{tabular}
\end{table}
...
Allocaridara Attack & 98,90\%  & 98,36\% & \textbf{98,63\%} & 183 \\
Healthy Leaf        & 96,95\%  & 97,45\% & 97,20\% & 196 \\
Leaf Blight         & \textbf{100,00\%} & 96,28\% & 98,10\% & 188 \\
Phomopsis Leaf Spot & 95,53\%  & 97,16\% & 96,34\% & 176 \\
\midrule
\textbf{Trung bình có trọng số} & \textbf{97,34\%} & \textbf{97,30\%} & \textbf{97,31\%} & \textbf{890} \\
\bottomrule
\end{tabular}
\end{table}
...
Độ chính xác trên tập huấn luyện đạt 99,03--99,85\%, cao hơn mức 97,30\% trên tập
...
\begin{enumerate}
    \item \textbf{Phân loại đạt 97,30\% trên tập kiểm thử} với $F_1$ 97,31\%, cả
