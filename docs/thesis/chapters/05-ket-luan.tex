...
\midrule
Phân loại năm lớp bệnh & Accuracy 97,30\%, $F_1$ 97,31\% trên 890 ảnh kiểm thử \\
...
Mô hình đạt \textbf{97,30\% độ chính xác} trên tập kiểm thử 890 ảnh, với $F_1$ có
trọng số 97,31\%. Độ chính xác kiểm định tốt nhất là 98,19\% tại epoch 11; khoảng
cách 0,89 điểm phần trăm giữa hai giá trị cho thấy mô hình khái quát tốt. Cả năm
...
kỳ công khoanh vùng thủ công nào. Mô hình phân loại đạt 97,30\% độ chính xác, và
